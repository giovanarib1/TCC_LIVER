    ...
    <nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-dark w-100">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../listar_obras_CL.php"> Pagina Inícial</a>
                    </li>
                    <li><hr class="dropdown-divider"></li>
                    <li class="nav-item">
    ...
    <!--NAVBAR TERMINA-->';
        ...
        function mostrarNavbarPerfil() {
            ...
            <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/js/bootstrap.min.js"></script>
                        ...
                        <a class="navbar-brand" href="../listar_obras_CL.php" >
                        <img src="../imagens/liver_logo.png" alt="Logo LiVer" src="index.php" width="100" height="40" ></a>
                        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarScroll" aria-controls="navbarScroll" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="navbar-toggler-icon"></span>
                    </button>
                    <div class="testenav">
                        <div class="collapse navbar-collapse" id="navbarScrollingDropdown">
                            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="editar_perfil.php">Alterar perfil</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../cadastro_obra/cadastro_obra.php">Cadastrar obra</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../listar_obras_CL.php">Resenhar</a>
                                </li>
                                <li class="nav-item">
        ...
        function mostrarNavbarPerfilDois() {
            echo '
            <!DOCTYPE html>
            <html lang="pt-br">
            <head>
                ...
                <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/css/bootstrap.min.css">
                <!-- CSS -->
                <link rel="stylesheet" href="css/perfildois.css">
        ...
        function mostrarNavbarLista() {
            ...
            <head>
                ...
                <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/css/bootstrap.min.css">
                <!-- CSS -->
                <link rel="stylesheet" href="perfil/listas.css">
        ...
        function mostrarNavbarTimeline() {
            echo '
            <!DOCTYPE html>
            <html lang="pt-br">
            <head>
