<!DOCTYPE html>
    ...
    <!--NAVBAR TERMINA-->
                ...
                if (mysqli_num_rows($result) > 0) {
                    $count = 1;  // Inicialize a variável $count
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<a href="../listar_obras_SL.php?id_obra=' . $id_obra . '&valor_obra=' . $valor_obra . '"><img src="../imagens/img_novelas/' . $row['FOTO_OBRA'] . '" alt="' . $row["NOME_OBRA"] . '" class="card-img-top"></a>';
                        echo '<div class="card-body" style="display: block; text-align: center;">';  
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
