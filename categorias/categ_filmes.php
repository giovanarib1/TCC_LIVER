<!DOCTYPE html>
 ...
 <!--NAVBAR-->
    ...
    <?php
                ...
                // Selecionando os filmes da tabela
                ...
                // Inicialize a variável $count
                   $count = 1;

// Abra a div de linha fora do loop
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo '<a href="../listar_obras_SL.php?id_obra=' . $id_obra . '&valor_obra=' . $valor_obra . '"><img src="../imagens/img_filmes/' . $row['FOTO_OBRA'] . '" alt="' . $row["NOME_OBRA"] . '" class="card-img-top"" /></a>';
    echo '<div class="card-body">';  // Exibir o corpo do card e centralizar o texto
    echo '</div>';
    echo '</div>';
    echo '</div>';
