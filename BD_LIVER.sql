...
CREATE TABLE IF NOT EXISTS `citacoes` (
  ...
  KEY `fk_citacoes_obra_idx` (`obra_ID_OBRA`),
...
INSERT INTO `citacoes` (`ID_CITACOES`, `DESC_CITACAO`, `obra_ID_OBRA`, `usuario_ID_USUARIO`) VALUES
(0, '', 0, 0),
(1, '“Se contar o acontecido já é uma traição com o vivido, pois muitas vezes, se trata de uma reconstrução malfeita de lembranças, recontar o que ouvimos pode ser dupla traição.”', 0, 29),
(2, '“As vezes a morte é leve como a poeira. E a vida se confunde com um pó branco qualquer.”', 0, 30),
(3, '“Você só precisa tomar cuidado para não ir de um extremo a outro”, o dr. Max disse. “O excesso de amor é tão perigoso quanto a falta.”', 0, 31),
(4, '\"reencarnar numa mosca deve ser coisa breve e por isso boa\"', 138, 32),
(5, '“Se o ar não se movimenta, não tem vento, se a gente não se movimenta, não tem vida.”', 127, 15),
(6, '\"Porque agora sabe que ela brilhará para ele entre mil estrelas no céu sem igual da cidade negra.“', 131, 32),
(7, '“… Lavei todas as roupas. Jurei nunca mais matar porco na favela. Eu estou tão nervosa que recordei o meu proverbio: não há coisa pior na vida do que a propria vida.”', 141, 32),
(8, '\"A imaginação foi a companheira de toda a minha existência, viva, rápida, inquieta, alguma vez tímida e amiga de empacar, as mais delas, capaz de engolir campanhas e campanhas, correndo.\"', 129, 26),
(9, '“Sou seu termômetro de criminalidade, seu espelho de morbidez, sua bússola de loucura. Mas a verdade é que, se estivesse no meu lugar, você teria feito o mesmo.”', 135, 29),
(10, '“Um dia você aprende a gostar mais de quem você é, e isso vai refletir em como as outras pessoas vão te enxergar. Gente babaca vai existir para sempre, mas a gente aprende a resistir.”', 137, 30),
(11, '“Nem sempre a família que nasce com a gente vai nos entender. Nem sempre eles vão ficar do nosso lado para sempre. Mas isso nunca vai te impedir de escolher uma família nova.”', 139, 31),
(12, '“Percebo que esse é o meu ideal de felicidade. Estar junto sem medo de que alguma coisa ruim vá acontecer a qualquer momento.”', 139, 26),
(13, '\"falar cansa, ouvir então nem se fale\"', 138, 15),
(14, '“Certa vez, em um banheiro público, havia um poema: A Carne mais barata do mercado. É a carne negra.”', 135, 31),
(15, '“Mas e o amor? O que é senão um monte de gostar? Gostar de falar, gostar de tocar, gostar de cheirar, gostar de ouvir, gostar de olhar. Gostar de se abandonar no outro. O amor não passa de um gostar de muitos verbos ao mesmo tempo.”', 136, 15),
(16, '“É preciso uma coincidência qualquer para que o amor se instale. Existe um certo milagre nos encontros. Não é tolo dizer que o amor é sagrado.”', 136, 29),
(17, '\"Pobres homens. Tolos, surdos, ignorantes, arraigados a uma tradição, incapazes de escutar o que transcendia a ela, impossibilitados de alcançar a verdade.\"', 0, 31),
(18, '\\\'eu faria de tudo para salvar nosso mundo\\\'', 0, 33),
(19, '\\\'Belonisia pegou a faca\\\'', 0, 34),
(24, '\\\"capitu me traiu\\\"', 129, 32);
...
CREATE TABLE IF NOT EXISTS `classificar` (
  ...
  KEY `fk_classificar_obra1_idx` (`obra_ID_OBRA`),
...
INSERT INTO `classificar` (`ID_CLASSIFICAR`, `NOTA_CLASSIFICAR`, `obra_ID_OBRA`, `usuario_ID_USUARIO`) VALUES
(20, '5.0', 87, 30),
(21, '5.0', 135, 30),
(22, '4.0', 31, 12);
...
CREATE TABLE IF NOT EXISTS `comentarios` (
  ...
  KEY `fk_comentarios_resenha1_idx` (`resenha_ID_RESENHA`)
...
INSERT INTO `comentarios` (`ID_COMENTARIO`, `TXT_COMENTARIO`, `resenha_ID_RESENHA`, `usuarios_ID_USUARIO`) VALUES
(3, 'eu discordo eu odiei totalmente', 7, 32),
(4, 'Amei muitoooo', 8, 30),
(5, 'SIIIM', 37, 30),
(6, 'Siiiiiiiiiiim', 35, 12),
(7, 'não acho', 44, 30),
(8, 'que resenha linda!', 8, 12);
...
INSERT INTO `curtir` (`ID_CURTIR`, `TIME_CURTIR`, `resenha_ID_RESENHA`, `resenha_usuario_ID_USUARIO`) VALUES
(1, '2023-09-05 05:41:25', 11, 27),
(2, '2023-09-05 05:41:26', 11, 15),
(3, '2023-09-05 05:41:38', 9, 27),
(4, '2023-09-05 05:41:38', 9, 15),
(5, '2023-09-05 11:27:02', 13, 34),
(6, '2023-09-05 11:27:02', 13, 16),
(7, '2023-10-30 18:00:57', 35, 32),
(8, '2023-10-30 18:00:57', 35, 27),
(9, '2023-10-30 18:00:57', 35, 15),
(10, '2023-10-30 18:01:06', 11, 32),
(11, '2023-11-02 22:13:35', 17, 24),
(12, '2023-11-02 23:01:40', 7, 27),
(13, '2023-11-03 17:02:12', 34, 34),
(14, '2023-11-03 17:02:12', 34, 16),
(18, '2023-11-20 20:46:29', 8, 30),
(19, '2023-11-21 02:07:24', 36, 12),
(20, '2023-11-21 02:48:20', 5, 12);
...
INSERT INTO `depois` (`ID_DEPOIS`, `obra_ID_OBRA`, `obra_perfil_ID_PERFIL`, `obra_perfil_usuario_ID_USUARIO`, `usuario_ID_USUARIO`) VALUES
(3, 4, 22, 30, 30),
(4, 1, 22, 30, 30);
...
CREATE TABLE IF NOT EXISTS `favoritos` (
  ...
  `TIPO_FAVORITO` int NOT NULL,
  `obra_ID_OBRA` int NOT NULL,
  `citacoes_ID_CITACOES` int NOT NULL,
  `obra_perfil_ID_PERFIL` int NOT NULL,
  `obra_perfil_usuario_ID_USUARIO` int NOT NULL,
  `usuario_ID_USUARIO` int NOT NULL,
  ...
  KEY `citacoes_ID_CITACOES` (`citacoes_ID_CITACOES`)
...
INSERT INTO `favoritos` (`ID_FAVORITOS`, `TIPO_FAVORITO`, `obra_ID_OBRA`, `citacoes_ID_CITACOES`, `obra_perfil_ID_PERFIL`, `obra_perfil_usuario_ID_USUARIO`, `usuario_ID_USUARIO`) VALUES
(5, 1, 34, 0, 28, 37, 37),
(7, 1, 144, 0, 24, 32, 32),
(16, 2, 137, 10, 24, 32, 32),
(17, 2, 129, 8, 24, 32, 32),
(19, 0, 3, 0, 24, 32, 32),
(21, 2, 138, 4, 24, 32, 32),
(23, 2, 141, 7, 24, 32, 32),
(24, 1, 127, 0, 24, 32, 32),
(25, 2, 127, 5, 24, 32, 32),
(26, 2, 136, 16, 24, 32, 32),
(27, 2, 128, 25, 22, 30, 30),
(28, 2, 129, 24, 22, 30, 30),
(29, 2, 136, 15, 11, 12, 12);
...
(52, 2, 'Records', 'ProduÃ§Ã£o Inepndente - Youtube', 16, '120', 'Flavia, Eduardo', 150, 33, 33);
...
(41, 149, 14, 14, 3, 'SBT', '23', 'Maria de SOuza', 14),
(42, 152, 34, 34, 3, 'SBT', '12', 'Maria de SOuza', 14);
...
(149, 3, 'Maria do bairro Ã© uma mulher', 'Maria do Bairro (PT-BR)', 'coisamaislinda(1).jpg', 'Huan DeLavegga', 2014, 14, 14),
(150, 2, 'Um amor proibido', 'O crepusculo de Eduardo e sua amada', 'Bandeira.jpg', 'Flavia GonÃ§alves', 2023, 33, 33),
(152, 3, 'Maria del bairro uma mulher', 'Maria ', 'acor(1).jpeg', 'Huan DeLavegga', 2014, 34, 34);
...
(11, 'Flavia', 'ahmad', 'Perfil_Flavia.jpg', 'Capa_Flavia.jpg', 'Tédioooo, já li tudo que tinha na minha estante', 12),
(13, 'Brunna Saraiva Oliveira', 'brwnia', '9a2ac83d7a6615ff395dfa0846267f24.jpg', 'f87d539c17eb98f48cc3574dcdd15f86.jpg', 'iiooo :3', 15),
(14, 'Roberta Oliveira', 'betinha', 'emily-entrega-curriculos-para-os-homens-com-quem-quer-sair-1662915305619_v2_450x450.jpg', '1dbfc66df441655f8c295b8e5eb88f56.jpg', 'Amo clássicos e séries', 16),
(17, 'Ivan', 'Ivan', 'ab2c0aac51463eee173f6d6472301f8d5704f12c_00.jpg', 'f65fedd9941df727ea7b4e58386bef58.jpg', 'sou um homem sabido', 24),
(19, 'Dalva da Silva', 'Dalvinha456', '1517531866155.jpeg', 'fca17ed6f86e0d561e9cb231ba765f95.png', 'Amo gatos e o outono.', 26),
(21, 'Letícia', 'dos_santos', 'tasha-tracie.jpg', '0ba4fec3cfc343957ec01f0dad35345f.jpg', 'faz o L de Letícia linda', 29),
(22, 'Murillo', 'murillo_ordonho11', 'Perfil_Murillo.jpg', 'Capa_Murillo.jpg', 'amo lol e meu namorado', 30),
(23, 'Nikolas', 'nik_b4bolim', 'f00bc13391095f7ecfd7c415335a02cc.jpg', 'abea600ce54db6b3f3eac0198c811c54.jpg', 'kayblack meu ídolo', 31),
(24, 'giovana', 'giovana.rib_', 'WhatsApp Image 2023-11-20 at 20.09.32.jpeg', 'dbb4a0b8d0c9ab6e8bc5d7e1297f6867.jpg', 'autores brasileiros eu amo vocês.\r\nmas ninguém acima da maioral', 32),
(31, 'Joelho', 'Joelho', 'dahelo1.jpg', '4c8e267ee4446e733bb17564337083f7.jpg', 'Curto Joelhos', 41);
...
(44, 'Cada vez gosto mais do Vitor Martins. O livro tem um bom senso de humor, e todas as referências à cultura pop me deixaram ainda mais entusiasmada pra ler. Ele fala sobre assuntos religiosos de uma forma direta. Cada detalhe especificamente pensado me fez apaixonar ainda mais por essa história. É um livro que faz rir em um momento e chorar no próximo, fiquei surpresa demaissss e tão absorta na história que li num piscar de olhos', '2023-11-20 20:22:36', 12, 139),
...
(42, 'Novela perfeita. Me distraiu nos momentos em que eu precisava', '2023-11-20 20:21:31', 12, 149),
(43, 'Os livros do Rafael Montes sempre superam minhas expectativas. Se você acertar qual é a reviravolta final da história, você pode se considerar um gênio. O livro é bem escrito e a história é ótima. Um ponto negativo foi que ele focou apenas no personagem principal e esqueceu de contar como os outros personagens estavam se sentindo na época, mas mesmo assim eu gostei muito desse livro, recomendo!!.', '2023-11-20 20:21:51', 12, 135),
(35, 'AMEI MUITO BOA DEMAISSSS', '2023-10-14 23:30:19', 32, 3),
(36, 'adorei um clássico realmente muito bom recomendo mt, vcs vao se emocinar com este romance tão belo!', '2023-11-02 22:14:29', 32, 129),
(38, 'Eu amo tanto essa sério, recomento para todo mundo. A história vai decorrer ao redor de alguns anjos da guarda, e da personagem principal feito pela maravilhosa da Kéfera!! Muito bom.\r\nMinha maior tristeza é, até hoje, essa série não ter continuação.', '2023-11-20 18:50:27', 12, 23),
(39, 'A série brasileira \"Coisa Mais Linda\" foi uma grata surpresa neste ano caótico. Confesso que tinha algumas dúvidas antes de começar a assistir, mas fui positivamente surpreendido, e agora estou ansioso pela segunda temporada. Embora apresente situações machistas que podem despertar indignação a ponto de querer desligar a TV, recomendo que não desistam, pois a forma como a trama se desenvolve é encantadora e, arrisco dizer, pode inspirar você a perseguir seus próprios sonhos. Sem dar spoilers, gostaria de enfatizar que é importante dar uma chance a essa produção brasileira, pois ela realmente vale a pena. Antes de concluir, devo aplaudir incessantemente o roteiro, a direção, a fotografia e, especialmente, a trilha sonora, que nos transporta para diferentes momentos. Se eu tivesse que resumir \"Coisa Mais Linda\" em uma palavra, seria: inspiradora.', '2023-11-20 19:51:32', 26, 3),
(40, 'É muito gratificante presenciar o crescimento dos autores brasileiros no cenário literário nacional, e Itamar Vieira Junior, sem dúvida alguma, conquistou seu merecido destaque. Sua prosa é delicada e honra a memória e a herança cultural de um povo que enfrentou inúmeras adversidades e ainda encara diversos desafios. Os personagens, cenários e eventos são retratados com vigor e uma minúcia excepcional. Torto Arado recebeu com justiça as honrarias que lhe foram concedidas e, certamente, deveria ser considerado uma leitura indispensável para todos os brasileiros.', '2023-11-20 19:51:51', 26, 127),
(41, 'MUITO BOM MEU DEUS DO CEU', '2023-11-20 20:03:01', 15, 4);
...
(36, '2023-09-05 05:40:57', 15, 14),
(38, '2023-11-20 20:47:12', 32, 30),
(39, '2023-11-20 21:33:54', 12, 41),
(40, '2023-11-20 21:34:16', 30, 41),
(42, '2023-11-21 02:09:33', 15, 12);
...
(32, 148, 14, 14, 1, 'Globoplay', 'Globoplay', 2, 12, 'Elza Soares, Joao ');
...
(33, 'flaviagoncalves908@gmail.com', 'FLAvia5980'),
(34, 'flavinha786@gmail.com', 'BRUnna10!!!'),
(35, 'suidnskdnis@gmail.com', 'BRUnna10!!!'),
(37, 'dnis@gmail.com', 'BRUnna10!!!'),
(39, 'oiioollkhgteste@gmail.com', 'BHVHsss!!!233'),
(41, 'FLAVINHkcsaA@gmail.com', 'BRUnna10!'),
(42, 'FLAVINHaaaA@gmail.com', 'FLAvia5980');
COMMIT;
